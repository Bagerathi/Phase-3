...
insert into Member values(2,'Garima Sen','2000-01-07',9,100)
insert into Member values(3,'Vignesh','2005-01-14',7,101)
insert into Member values(4,'Bhargavi','2000-04-17',3,108)
insert into Member values(5,'Anana','2000-03-13',2,500)
insert into Member values(6,'Pavithra','2000-04-19',5,50)
insert into Member values(7,'Nive',CURRENT_TIMESTAMP,3,null)
...
--Msg 8115, Level 16, State 8, Line 59
...
--25
update Member set Penalty_Amount = 300 where Member_Name = 'Vignesh'
